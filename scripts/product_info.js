...
(function () {
  ...
  document.querySelector('.btn-submit').addEventListener('click', function (e) {
    ...
    //temporary action to show the quantity selected;
    // this should be replaced with adding to local storage list
    if (quantity < 1) {
  ...
  try {
    ...
    fetch(`https://dummyjson.com/products/${product_id}`)
      ...
      .then(data => {
        ...
        document.querySelector('#product-img').alt = `An image of: ${data.title}`;
      })
